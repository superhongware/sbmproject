...
productsmodule.controller('productsCtrl', [
	'$scope', '$ionicLoading', '$rootScope', '$state', '$ionicScrollDelegate', 'productComm', 'getDataComm', 'loginCheck', 'TBAPI', 'showedition','myCookie',
	function($scope, $ionicLoading, $rootScope, $state, $ionicScrollDelegate, productComm, getDataComm, loginCheck, TBAPI, showedition,myCookie) {
